...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                mContext.getString(R.string.pref_keys_unit_type),
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            for(int i = 0; i < weatherArray.length(); i++) {
                ...
                weatherValues.put(WeatherContract.WeatherEntry.HUMADITY, humidity);
                ...
                weatherValues.put(WeatherContract.WeatherEntry.MAX, high);
                weatherValues.put(WeatherContract.WeatherEntry.MIN, low);
                weatherValues.put(WeatherContract.WeatherEntry.SHORT_DESC, description);
