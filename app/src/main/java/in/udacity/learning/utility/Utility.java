...
public class Utility {
    ...
    static public int getLocationStatus(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return prefs.getInt(context.getString(R.string.pref_keys_location_key_status), SunshineSyncAdapter.LOCATION_STATUS_UNKNOWN);
    }

    /*Reset LocationStatus*/
    static public void resetLocationStatus(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt(context.getString(R.string.pref_keys_location_key_status), SunshineSyncAdapter.LOCATION_STATUS_UNKNOWN);
        editor.apply();
    }
    ...
    public static boolean usingLocalGraphics(Context context) {
        ...
        return prefs.getString(context.getString(R.string.pref_key_icon),
    ...
    public static Asset getAsset(Bitmap bitmap) {
